                ...
                <section class="infograph">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="col-12 order-md-2">
                                <div class="card" style="border: 2px solid black; margin: 20px; margin-top: 40px; margin-bottom: 10px; height: 100px;">
                                    <div class="card-body" style="display: flex; padding: 0.5rem 0.5rem;">
                                    <form id="form_s">
                                    <div class="form-group">
                                    <label for="indikator">Prov</label>
                                    <select class="form-control inp_pro" name="inp_pro" id="inp_pro">
...
<script>
    ...
    function peta(){
        mapboxgl.accessToken = 'pk.eyJ1IjoiZnJhbnNhbGFtb25kYSIsImEiOiJja2NlZ2xtMjkwMzgxMzJubm9paGJ5dmMyIn0.QJc2VJF6md9CaTilCmgYag';
               url = "http://localhost/WWW/portal_peppd/media/C_infographController/peta";
